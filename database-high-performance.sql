-- 🚀 HIGH-PERFORMANCE DATABASE OPTIMIZATION FOR 120+ CONCURRENT USERS
...
-- 2. Performance indexes for 120+ concurrent users
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_voter_profiles_dashboard 
ON voter_profiles (is_admin, has_voted, first_name);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_candidates_dashboard 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_election_votes_performance
